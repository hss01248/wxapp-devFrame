...
Page({
  data: {
    title:'',//todo 设置标题栏
      ...
      currentPageIndex:1,
      currentAction : 0,
      urlTail:API.Album.LABEL_SEARCH,//todo 需补全的,页面请求的url
  ...
  console.log(e);
   ...
   //  }
    ...
    getListFromNetData:function(netData){
       ...
       var data  = utils.to2DimensionArr(netData,3);
...
/* {
 "coverUrl": "http://static.qxinli.com/248_2016-01-20_16-31-49_300_300.jpg",
 "id": 327,
 "playCount": 2270,
 "title": "qxinli测试发布音频",
 "type": 1
 ...
 type  : 1 为 微课, 2 为 课程
    ...
    handldItemInfo:function(info){
       // info.items=utils.arrayToDoubleArray(info.items,3);
       /* if(info.type==1){
            info.typeText='微课';
